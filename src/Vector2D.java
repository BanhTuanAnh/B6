public class Vector2D {
    ...
    public Vector2D rotate (double angle) {
        ...
        Vector2D cloneThis = new Vector2D();
        cloneThis.x=(float)((this.x * Math.cos(angle)) - (this.y * Math.sin(angle)));
        cloneThis.y = (float)((this.x * Math.sin(angle)) + (this.y * Math.cos(angle)));
        return cloneThis;
    }
